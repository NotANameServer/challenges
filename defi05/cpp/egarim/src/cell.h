 ...
 *
 * Etat d'une forêt (par défaut elle est en cendre) et ses conditions pour changer détat.
 *
 * La liste des conditions est à prendre en compte par priorité.
 * C'est à dire que la première condition remplie fait changer d'état la forêt et les suivantes sont ignorées.
 *
 ...
 *
 * Représente la position d'une forêt sur une surface 2D et son Etat.
 */
